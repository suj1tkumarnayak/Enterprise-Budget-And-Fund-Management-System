 ...
 *
 * M2 additions (TASK-FE-001):
 * - NavLink with active-route highlighting via Tailwind
 * - User name / role displayed in sidebar footer
 * - Logout button wired to useLogout hook
 */
...
/** Derive initials from full name for the avatar placeholder. */
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="flex w-64 flex-col border-r border-gray-200 bg-white">
        ...
        {/* Navigation — TASK-FE-001: NavLink active-route highlighting */}
        ...
        {/* User area — populated in M2 from auth Zustand slice */}
        <div className="shrink-0 border-t border-gray-200 p-4">
          {user !== null ? (
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-brand-100 text-xs font-semibold text-brand-700 ring-2 ring-brand-200">
            ...
            <div className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-gray-100 ring-2 ring-gray-200" />
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-medium text-gray-400">Not signed in</p>
              </div>
            </div>
          )}
        </div>
